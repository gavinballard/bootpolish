...
templates.variable = new bootpolish.Hogan.Template(function(c,p,i){i = i || "";var b = i + "";var _ = this;b += "<label>";b += (_.v(_.f("name",c,p,0)));b += "</label>";b += "\n" + i;if(_.s(_.f("colour",c,p,1),c,p,0,35,60, "{{ }}")){b += _.rs(c,p,function(c,p){ var b = "";b += _.rp("variable_colour",c,p,"  ");return b;});c.pop();}else{b += _.b; _.b = ""};if(_.s(_.f("size",c,p,1),c,p,0,81,104, "{{ }}")){b += _.rs(c,p,function(c,p){ var b = "";b += _.rp("variable_size",c,p,"  ");return b;});c.pop();}else{b += _.b; _.b = ""};if(_.s(_.f("text",c,p,1),c,p,0,123,146, "{{ }}")){b += _.rs(c,p,function(c,p){ var b = "";b += _.rp("variable_text",c,p,"  ");return b;});c.pop();}else{b += _.b; _.b = ""};return b;;});
...
templates.variable_size = new bootpolish.Hogan.Template(function(c,p,i){i = i || "";var b = i + "";var _ = this;b += "<input type=\"text\" class=\"input-large\" value=\"";b += (_.v(_.f("value",c,p,0)));b += "\" placeholder=\"";b += (_.v(_.f("value",c,p,0)));b += "\" data-variable=\"";b += (_.v(_.f("name",c,p,0)));b += "\" data-type=\"size\" />";return b;;});
templates.variable_text = new bootpolish.Hogan.Template(function(c,p,i){i = i || "";var b = i + "";var _ = this;b += "<input type=\"text\" class=\"input-large\" value=\"";b += (_.v(_.f("value",c,p,0)));b += "\" placeholder=\"";b += (_.v(_.f("value",c,p,0)));b += "\" data-variable=\"";b += (_.v(_.f("name",c,p,0)));b += "\" data-type=\"text\" />";return b;;});
